...
public class ChatBot extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activtiy_chatbot);
...
//        String url = "http://api.brainshop.ai/get?bid=166098&key=QR9LBHwdHsmzwF9N&uid=[uid]&msg="+ userMsg;
        String url = "http://api.brainshop.ai/get?bid=166501&key=G1dqufdyxCzXlRNJ&uid=166501&msg="+ userMsg;
